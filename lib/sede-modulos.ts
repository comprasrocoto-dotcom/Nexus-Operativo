...
export type DefinicionModulo = {
    // La clave es libre (string) por diseño data-driven: el registro es la fuente de
    // verdad y puede sobreescribirse/extenderse desde Op_Modulos en runtime. No se
    // acopla a la taxonomía de eventos (ClaveModulo) para poder crecer sin tocar tipos.
    clave: string;
    etiqueta: string;
