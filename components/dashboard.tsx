...
// No importa mock-data: todas las cifras, documentos y modulos son datos reales.
...
agenda: "/operaciones/sedes",
observaciones: "/operaciones/sedes",
evidencias: "/operaciones/sedes",
indicadores: "/operaciones/sedes",
usuarios: "/admin",
roles: "/admin",
permisos: "/admin",
eventos: "/admin",
...
function rutaModulo(clave: string): string {
return RUTAS[clave] ?? "/modulos/" + clave;
}
...
[politicas, procedimientos, manuales, sedesOperativas, inventarios, compras, auditorias, actividades, indicadores, evidencias, eventos],
);
...
<span>{conteos[clave] ?? 0} registros</span>
